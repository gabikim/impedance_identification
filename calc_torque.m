function [torque_delt_calc, torque_delt_actual, error, percent_calc, torqueU_resized, torqueP_resized, W_trainRHF, W_trainRKF] = calc_torque(testNum, moving_windowSize, shifted_petSize, percent_testVec, W_train, X_testVec, torque_delt_testVec, torqueU_actual, torqueP_actual)
    count = 0;
