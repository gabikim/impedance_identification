function [valid] = plot_torqueCalc(delt_error, RKFtorque_calc, RHFtorque_calc, corrRMSE_matrix, percent_calc, count_step, torque_delt_actual, RHFtorque_delt_calc, RKFtorque_delt_calc, torqueP_actual_curr, torqueU_actual_curr)
%UNTITLED Summary of this function goes here
    ...
    ylabel('\Delta error')
    title(['RHF, correlation coefficient: ' num2str(corrRMSE_matrix(count_step,1,1))])
    set(gca, 'XTickLabel', []);
    ...
    title(['RKF, correlation coefficient: ' num2str(corrRMSE_matrix(count_step,1,2))])
    set(gca, 'XTickLabel', []);
